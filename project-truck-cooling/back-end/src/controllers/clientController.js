...
export const createClient = async (req, res) => {
  ...
  try {
    ...
    let transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'irnidwi16@gmail.com', 
        pass: 'pqka nzap jvot nmdq', 
      },
    });

    let mailOptions = {
      from: 'irnidwi@gmail.com',
      to: email,
...
// Add these test queries to your code temporarily
export const testClientQueries = async (req, res) => {
  try {
    // Test 1: Simple SELECT
    const test1 = await pool.query('SELECT * FROM public.client LIMIT 1');
    ...
    console.error('Test queries error:', err);
